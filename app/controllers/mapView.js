...
//set the region aroudn the photo
$.mapview.setRegion({
...
//handle the event and clsoe the window
...
$.getView().addEventListener("open", function() {
	OS_ANDROID && ($.getView().activity.onCreateOptionMenu =
	 funciton() {
	 	var acrtionBar = $.getView().activity.actionBar;
	 	if (acitonBar) {
